...
export default {
	...
	config_main_header: "{{emote_wrench}} Spark configuration for **{{guild.name}}** `({{guild.id}})`",
	config_main_options: {
		language: "Language",
	...
	github_source_code: "{{emote_github}} Spark is a fully open source project. You can find the source code at our GitHub repository **[here](https://github.com/TeamBulbbot//Bulbbot)**",

	invite_content: "Links to invite Spark to your server",
	...
	commands_help: "You can find all the commands Spark offers over **[here](https://docs.bulbbot.rocks/basics/command-list)**",
	...
	sc_commands_desc: "Return a list of all available commands for Spark",
